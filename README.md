...
[![Vitest Coverage](https://img.shields.io/badge/Vitest-144%2F144_Passed_(96.63%25)-green?style=for-the-badge&logo=vitest)](https://vitest.dev/)
...
| **09** | **Slide-Over Checkout Drawer** | Hardware-accelerated 400ms slide-in/out cubic-bezier drawer with backdrop tap/click outside dismissal, Escape key handling, live personalized laser engraving with **animated CNC laser spark focal indicator**, warranty selection, instant reservation code dispatch, and **1-click clipboard copy with checkmark feedback**. |
...
| `npm test` | **Vitest Test Suite** | Runs all 44 test suites (144 tests) with v8 code coverage reporting |
...
4. **Pass 3 (Vitest Client UI & Primitives):** Executes all test suites and asserts **≥ 85% code coverage** (*current: 96.63%*).
