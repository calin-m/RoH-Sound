      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <MotionReveal direction="up" delay={50} className="md:col-span-8 flex">
            <div className="w-full bg-white rounded-3xl p-8 border border-black/[0.06] shadow-sm flex flex-col justify-between group hover:shadow-md transition-shadow">
