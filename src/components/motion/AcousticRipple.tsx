...
export const AcousticRipple: React.FC<AcousticRippleProps> = ({
  ...
  return (
    ...
    >
      {/* Pure Circular Sub-Bass Transducer Pressure Glow (0.7x Intensity) */}
      <div className="absolute w-72 h-72 rounded-full bg-radial from-[#b8934a]/20 via-[#d4af37]/08 to-transparent blur-2xl animate-pulse" />
